...
(function() {
  var db, iced, mongo, __iced_k, __iced_k_noop;
  ...
  exports.post_login = function(req, res) {
    var insert_user, result, team_assignment, ___iced_passed_deferral, __iced_deferrals, __iced_k,
      _this = this;
    ...
    (function(__iced_k) {
      __iced_deferrals = new iced.Deferrals(__iced_k, {
        ...
        filename: "src/server/routes/index.coffee",
        funcname: "post_login"
      });
      insert_user(req, __iced_deferrals.defer({
        assign_fn: (function() {
          return function() {
